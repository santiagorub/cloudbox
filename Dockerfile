...
RUN apt-get update && apt-get install -y wget && \
    ...
    # ------ ¡¡LÍNEA AGREGADA!! ------
    # Esta es la dependencia que te faltaba
    wget https://repo1.maven.org/maven2/org/simpleframework/simple-xml/2.7.1/simple-xml-2.7.1.jar -O /app/simple-xml.jar && \
    # ---------------------------------
...
# Este comando usa los JARs que descargaste
...
# Este comando también usa los JARs que descargaste
